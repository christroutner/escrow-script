/*
  This JS app generates the P2SH address for the fee. This address is funded
  at the same time as the escrow contract, by the Seller. If the trade does
  not succeed, it can be reclaimed by the Seller. Otherwise the fee goes to
  the Arbiter. The Arbiter can also return the fee to the Seller.
*/
...
const UTXO = {
  tx_hash: 'ccd39e5af21ad9d412349b2a2cf66dc70b993e7326d3f0cc5d69c7d28d1fe35e',
  tx_pos: 0,
  value: 10000
}
